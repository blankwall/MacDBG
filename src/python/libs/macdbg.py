...
class MacDbg:
    ...
    def info_pretty_print(self, thread):
        ...
        print bcolors.FAIL + "R8:  " + bcolors.ENDC + self.return_info(x["r8"])
        print bcolors.FAIL + "R9:  " + bcolors.ENDC + self.return_info(x["r9"])
        print bcolors.FAIL + "R10: " + bcolors.ENDC + self.return_info(x["r10"])
        print bcolors.FAIL + "R11: " + bcolors.ENDC + self.return_info(x["r11"])
        print bcolors.FAIL + "R12: " + bcolors.ENDC + self.return_info(x["r12"])
        print bcolors.FAIL + "R13: " + bcolors.ENDC + self.return_info(x["r13"])
        print bcolors.FAIL + "R14: " + bcolors.ENDC + self.return_info(x["r14"])
        print bcolors.FAIL + "R15: " + bcolors.ENDC + self.return_info(x["r15"])
